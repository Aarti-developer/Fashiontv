...
<body>
    ...
    <main class="privacypol-page">
        <div class="image-section">
            <img src="/assets/img/e-poster.jpg" alt="Image">
        </div>
        <!--  -->
        <div class="container">
            <h1 class="my-5">FashionTV Privacy Policy</h1>
            <p>
                FashionTV India operates fashiontv.in. This page informs you of our
                policies regarding the collection, use, and disclosure of personal
                information we receive from users of the site. We use your Personal
                Information only for internal FTV fashiontv.in internal processes and
